...
root_path = '/data/nir_data/2017_05_22/NoSpectralCorrection/'
data_path = root_path + 'PreprocessedImages/'
model_path = root_path + 'results/training03_tiedStructuredImproved/models/model_ae_tied_complex_loss-71400.meta'
output_path = root_path + 'results/training03_tiedStructuredImproved/inference.hdf5'
